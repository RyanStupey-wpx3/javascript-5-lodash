...
// Bonus Points
const totalByMonth = _.reduce(purchasesByMonth, function(memo, num){return memo + num},0); // Use the grouped purchasesByMonth and reduce to create a totalByMonth object.
